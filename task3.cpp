...
void selectCache()
{
    cout<<"Enter 1: for Direct Mapped Cache\n2: for Fully Associative Cache\n3: for Set Associative Cache\n";
    cin>>cacheType;
    if(cacheType==1)
    {
        int x,y;
        cout<<"Enter x, where 2^x is the cache size in bytes:"<<endl;
        cin>>x;
        cout<<"Enter block size in words:"<<endl;
        cin>>y;
        n = x-y-2;
        m = y;
    ...
    else if(cacheType==3)
    {
        ...
        cout<<"Enter block size in words:"<<endl;
        cin>>y;
        cout<<"Enter k, where cache is required to be 2^k-way associative:"<<endl;
        cin>>k;
        n = x-k-y-2;
        m=y;
        k = 1<<k;
